...
int main(int argc, char *argv[]) {
    ...
    benchMarkEuclideanDistance(hwaccelerated::GenericAccelrator(), length, count);
    ...
    benchmark_dot_product(hwaccelerated::GenericAccelrator(), length, count);
    ...
    benchmark_popcount(hwaccelerated::GenericAccelrator(), length, count);
